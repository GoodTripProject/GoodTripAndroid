...
public class PlanTripFragment extends Fragment {
    ...
    private void setupAddCountryPopup(View popupView, PopupWindow popupWindow) {
        ...
        final AutoCompleteTextView autoCompleteTextViewCountries = popupView.findViewById(R.id.enter_country_name);
        ArrayAdapter<String> adapter = new ArrayAdapter<>
                (requireContext(), android.R.layout.select_dialog_item, mViewModel.getCountriesList().toArray(new String[0]));
        autoCompleteTextViewCountries.setThreshold(1);
